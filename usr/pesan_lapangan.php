                                ...
                                <div class="table-responsive table-striped">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" >
                                        ...
                                        <tbody>
                                            <?php
                                            $id = $_SESSION['idUser'];
                                            $dataStock = mysqli_query($conn, "SELECT * FROM data_pesan_lapangan masuk, data_lapangan daftarLapangan, data_user daftarUser, data_hari daftarHari WHERE daftarLapangan.id_lapangan = masuk.id_lapangan && masuk.id_user = daftarUser.id_user && masuk.id_user = '$id' && masuk.id_hari = daftarHari.id_hari");
                                            $i = 1;
